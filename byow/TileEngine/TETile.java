 ...
 * appropriate size (16x16) to be drawn in addPlaceable of the unicode representation. If the image path
 * provided cannot be found, addPlaceable will fallback to using the provided character and color
...
public class TETile implements Serializable {
     ...
     * will not even try to addPlaceable an image, and will instead use the provided character and colors.
     * @param character The character displayed on the screen.
     * @param textColor The color of the character itself.
     * @param backgroundColor The color drawn behind the character.
     * @param description The description of the tile, shown in the GUI on hovering over the tile.
     ...
     * we addPlaceable the image located at that filepath to the screen. Otherwise, we fall
    ...
    /** Hero representation of the tile. Used for drawing in text mode.
